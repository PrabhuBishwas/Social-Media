...
class Message {
  ...
  public function getConvos() {
    ...
    foreach($convos as $username) {
      ...
      $return_string .= "<a href='messages.php?u=$username'> <div class='user_found_messages'>
                        ...
                        ".$user_found_obj->getFirstAndLastName()." <span class='timestamp_smaller' id='grey'>".$latest_message_details[2]."</span>
  ...
  public function getConvosDropdown($data, $limit) {
    ...
    if($count > $limit){
      ...
      $return_string .= "<input type='hidden' class='noMoreDropdownData' value='true' /> <p style='text-align:center;'>
