...
<div class="main_column column" id="main_column">
  ...
  if($type == "username") {
    ...
    //If query contain underscore, assume user is searching for usernames
    ...
    echo "<a href='search.php?q=" .$query. "&type=name'>Name</a>, <a href='search.php?q=" .$query. "&type=username'>Username</a><br /><hr id='search_hr' />";
