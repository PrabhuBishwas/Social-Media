  ...
  <body>
    ...
    if(isset($_POST['postComment'.$post_id])) {
      ...
      if($check_empty != "") {
        ...
        $get_commenters = mysqli_query($con, "SELECT * FROM comments WHERE id='$post_id'");
     ...
     ?>
     <form class="" action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="post">
